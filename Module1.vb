Module Module1
    ...
    Function CheckRows(ByVal grid As Char(,)) As Boolean
        ...
        For column = 0 To 2
            If grid(column, 0) = "X" Or grid(column, 0) = "0" Then
                If grid(column, 0) = grid(column, 1) And grid(column, 1) = grid(column, 2) Then
                    completedRow = True
                End If
            End If
    ...
    Function CheckDiagonals(ByVal grid As Char(,)) As Boolean
        ...
        If grid(1, 1) = "0" Or grid(1, 1) = "X" Then
            If (grid(0, 0) = grid(1, 1) And grid(1, 1) = grid(2, 2)) Or (grid(0, 2) = grid(1, 1) And grid(1, 1) = grid(2, 0)) Then
